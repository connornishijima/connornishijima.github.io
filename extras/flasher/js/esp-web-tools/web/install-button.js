const e = async (t) => {
    let o;
    import("./install-dialog-CQzvAv3p.js");
    try {
        o = await navigator.serial.requestPort();
    } catch (o) {
        return "NotFoundError" === o.name ? void import("./index-BaUGegDD.js").then((o) => o.openNoPortPickedDialog(() => e(t))) : void alert(`Error: ${o.message}`);
    }
    if (!o) return;
    try {
        await o.open({ baudRate: 921600 });
    } catch (e) {
...
class t extends HTMLElement {
    connectedCallback() {
        ...
        if (((this.renderRoot = this.attachShadow({ mode: "open" })), !t.isSupported || !t.isAllowed))
            return (
